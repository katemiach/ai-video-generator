  ...
  */
  async function generateVideo() {
    ...
    const confirmed = window.confirm(
      "Запустить реальную генерацию?\n\n" +
        "Запрос может расходовать баланс OpenRouter.",
    );
    ...
    try {
      ...
      if (!createdJob?.id) {
        throw new Error(
          "OpenRouter не вернул идентификатор задания",
        );
      }
          ...
          <div className="section-block">
            <div className="section-title">
              ...
              <div>
                ...
                <p>
                  Пока используется для предварительного просмотра
                </p>
              </div>
            </div>
